    ...
    <aside class="h-screen sticky top-0 flex flex-col bg-base-200 overflow-y-auto">
        ...
        <div class="flex flex-col border-base-300 px-2 pt-4 grow">
            <div class="flex flex-row justify-end space-x-1">
                ...
                <button class="btn btn-ghost btn-square btn-sm" on:click={refreshPostings}>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
            ...
            <div class="flex flex-col divide-y divide-base-300">
                <ul class="menu menu-s px-0">
                    ...
                    <li class="font-bold">
                        <button on:click={() => select("bookmarked")} class="{selected == "bookmarked" ? "active" : ""}">
...
<ul id="contextMenu" class="menu bg-base-200 w-56 rounded-box absolute bg-base-100 shadow-xl" style="position: absolute; left: {contextMenuPosition.x}px; top: {contextMenuPosition.y}px;">
    <li>
        <button>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
